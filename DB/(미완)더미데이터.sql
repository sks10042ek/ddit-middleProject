...
(CO_CODE   ASC,MEM_ID   ASC,CP_DATE ASC);



ALTER TABLE CP_HAVING
	ADD CONSTRAINT  XPK쿠폰_보유자 PRIMARY KEY (CO_CODE,MEM_ID,CP_DATE);
...
(
    ...
    GB_CIN               DATE NOT NULL,
    GB_COUT              DATE NOT NULL,
    GB_RPRICE            NUMBER(10) NOT NULL,
    GB_DPRICE            NUMBER(10) NOT NULL,
...
(
	MIL_CODE             VARCHAR2(10) NOT NULL ,
	MEM_ID               VARCHAR2(30) NOT NULL ,
    MIL_HIS              VARCHAR2(30) NOT NULL,
    MIL_AMT              NUMBER(10) NOT NULL,
    MIL_TOTAL           NUMBER(10) NOT NULL,
    MIL_DATE             DATE NOT NULL
...
--ACCOMODATION
 ...
 create sequence acc_seq         
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'호텔 더원','제주시','010-1212-8897' ,0,'1500','1100','호텔');  

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제주 아모렉스 리조트','제주시','010-2244-7897' ,0,'1300','1100','호텔');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'파크 선샤인 제주','서귀포시','010-7877-2252' ,0,'1300','1100','호텔');  
  
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'더 그랜드 섬오름','서귀포시','010-2252-3333' ,0,'1200','1100','호텔');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'휘닉스 제주 섭지코지','동부','010-8855-1166' ,0,'1200','1200','호텔');  
 
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'아름다운 리조트','동부','010-0948-8855' ,0,'1200','1200','호텔');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'코업시티호텔 성산','서부','010-8899-2626' ,0,'1200','1100','호텔'); 
  
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'코델리아 리조트','서부','010-9986-4545' ,0,'1300','1100','호텔');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제주노을풀빌라','제주시','010-9514-5485' ,0,'1500','1100','펜션'); 

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제주길리리조트펜션','제주시','010-9452-2584' ,0,'1500','1100','펜션'); 
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'풀스테이사계','서귀포시','010-6542-2892' ,0,'1500','1100','펜션');  

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'JB풀빌라','서귀포시','010-6323-5475' ,0,'1500','1100','펜션');  
...
insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'야크마을','동부','010-0121-0011' ,0,'1500','1100','펜션');  

insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제이브루더 풀빌라','동부','010-5544-1121' ,0,'1500','1100','펜션');
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'스테이디앤디풀빌라','서부','010-0147-5485' ,0,'1500','1100','펜션');  

insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'꾸꾸풀빌라','서부','010-2418-0045' ,0,'1500','1100','펜션');
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제주 삼다 게하','제주시','010-4465-9999' ,0,'1500','1100','게하'); 

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제주 담스테이','제주시','010-4466-9999' ,0,'1500','1100','게하');  

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'비케이 인 제주','제주시','010-4467-9999' ,0,'1500','1100','게하');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'올레요','서귀포시','010-4468-9999' ,0,'1500','1100','게하');  

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'제이앤비','서귀포시','010-4469-9999' ,0,'1500','1100','게하');  
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'퐁낭에염','동부','010-4465-9999' ,0,'1500','1100','게하');  

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'샨티샨티 게스트하우스','동부','010-4465-9999' ,0,'1500','1100','게하');
  ...
  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'필링 굿 하우스','서부','010-4465-9999' ,0,'1500','1100','게하'); 

  insert into accommodation (a_code, a_name, a_addr, a_tel, a_wnum, a_entime, a_extime, a_type)         
  values('JJAC23' || lpad(acc_seq.nextval,4,'0'),'봉스테이','서부','010-4465-9999' ,0,'1500','1100','게하');
...
CREATE SEQUENCE mil_seq INCREMENT BY 1
   ...
   values('ML23' || lpad(mil_seq.nextval,5,'0'),);  
...
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230010','스위트','2', '3', '550000', '5'); 
    ...
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230012','스위트','2', '3', '550000', '5'); 
            ...
            insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230013','스탠다드','1', '2', '250000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230013','슈퍼리어','1', '2', '350000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230013','디럭스','2', '3', '450000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230013','스위트','2', '3', '550000', '5');  
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230014','스탠다드','1', '2', '250000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230014','슈퍼리어','1', '2', '350000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230014','디럭스','2', '3', '450000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230014','스위트','2', '3', '550000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230015','스탠다드','1', '2', '250000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230015','슈퍼리어','1', '2', '350000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230015','디럭스','2', '3', '450000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230015','스위트','2', '3', '550000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230016','스탠다드','1', '2', '250000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230016','슈퍼리어','1', '2', '350000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230016','디럭스','2', '3', '450000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230016','스위트','2', '3', '550000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230017','스탠다드','1', '2', '250000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230017','슈퍼리어','1', '2', '350000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230017','디럭스','2', '3', '450000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230017','스위트','2', '3', '550000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230018','스탠다드','1', '2', '250000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230018','슈퍼리어','1', '2', '350000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230018','디럭스','2', '3', '450000', '5');  
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230018','스위트','2', '3', '550000', '5'); 
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230019','스탠다드','1', '2', '250000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230019','슈퍼리어','1', '2', '350000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230019','디럭스','2', '3', '450000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230019','스위트','2', '3', '550000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230020','스탠다드','1', '2', '250000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230020','슈퍼리어','1', '2', '350000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230020','디럭스','2', '3', '450000', '5'); 
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230020','스위트','2', '3', '550000', '5');         ---- 호텔
    ...
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230024','A타입','2', '4', '85000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230024','B타입','3', '5', '90000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230025','A타입','2', '4', '125000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230025','B타입','3', '5', '110000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230026','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230026','B타입','3', '5', '95000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230027','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230027','B타입','3', '5', '95000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230028','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230028','B타입','3', '5', '95000', '5'); 
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230029','A타입','2', '4', '125000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230029','B타입','3', '5', '90000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230030','A타입','2', '4', '125000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230030','B타입','3', '5', '110000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230031','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230031','B타입','3', '5', '95000', '5'); 
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230032','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230032','B타입','3', '5', '95000', '5');
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230033','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230033','B타입','3', '5', '95000', '5');
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230034','A타입','2', '4', '10000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230034','B타입','3', '5', '95000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230035','A타입','2', '4', '85000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230035','B타입','3', '5', '90000', '5'); 

    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230036','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230036','B타입','3', '5', '95000', '5');
    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230037','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230037','B타입','3', '5', '95000', '5');
    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230038','A타입','2', '4', '75000', '5'); 
        insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230038','B타입','3', '5', '95000', '5');
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230039','A타입','2', '4', '95000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230039','B타입','3', '5', '130000', '5'); 

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230040','A타입','2', '4', '155000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230040','B타입','3', '5', '140000', '5');   

    -----------펜션
    
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230041','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230041','4인실(남자)','3', '4', '35000', '5');
    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230042','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230042','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230043','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230043','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230044','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230044','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230045','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230045','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230046','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230046','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230047','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230047','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230048','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230048','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230049','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230049','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230050','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230050','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230051','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230051','4인실(남자)','3', '4', '35000', '5');


     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230052','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230052','4인실(남자)','3', '4', '35000', '5');
    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230053','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230053','4인실(남자)','3', '4', '35000', '5');
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230054','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230054','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230055','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230055','4인실(남자)','3', '4', '35000', '5');

    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230056','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230056','4인실(남자)','3', '4', '35000', '5');
    
         insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230057','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230057','4인실(남자)','3', '4', '35000', '5');
    
             insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230058','4인실(여자)','3', '4', '35000', '5'); 
     insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
    values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230058','4인실(남자)','3', '4', '35000', '5');
    
    insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230059','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230059','4인실(남자)','3', '4', '35000', '5');

insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230060','4인실(여자)','3', '4', '35000', '5');
insert into ROOM (R_CODE, A_CODE, R_TYPE, R_MIN, R_MAX, R_PRICE, R_INVEN)
values('JJRM23' || lpad(rom_seq.nextval,4,'0'),'JJAC230060','4인실(남자)','3', '4', '35000', '5');          --게스트 하우스
...
CREATE SEQUENCE GB_seq INCREMENT BY 1
    ...
    insert into GROUPBUYING (GB_CODE, GB_CIN, GB_COUT, GB_PRICE, GB_DPRICE, GB_TITLE, GB_CONTENT, GB_INVEN, GB_DATE)
    values('JJGB23' || lpad(GB_seq.nextval,4,'0'),);
...
CREATE SEQUENCE PH_seq INCREMENT BY 1
    ...
    values('J' || lpad(PH_seq.nextval,10,'0'),'프로필','오리진사진1.jpg');  
...
VALUES('CO001', '숙소 할인', 5);

INSERT INTO coupon (CO_CODE, CO_NAME, CO_RATE)
VALUES('CO002', '숙소 할인', 10);

INSERT INTO coupon (CO_CODE, CO_NAME, CO_RATE)
VALUES('CO003', '숙소 할인', 15);
...
VALUES('CO001','LittleQueka',0,'2023-07-23');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO002','LittleQueka',1,'2023-07-20');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO003','LittleQueka',1,'2023-07-15');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO001','BigQueka',1,'2023-06-23');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO002','BigQueka',1,'2023-06-19');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO003','BigQueka',1,'2023-05-23');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO001','MiddleQueka',0,'2023-07-23');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO002','MiddleQueka',0,'2023-08-03');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO003','MiddleQueka',1,'2023-08-02');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO001','CutieQueka',0,'2023-08-13');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO002','CutieQueka',1,'2023-08-25');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO003','CutieQueka',0,'2023-07-20');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO001','PrettyQueka',1,'2023-07-21');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO002','PrettyQueka',1,'2023-07-23');

INSERT INTO CP_HAVING (CO_CODE, MEM_ID, CP_USE, CP_DATE)
VALUES('CO003','PrettyQueka',0,'2023-08-01');
COMMIT;
------------------------------------------------------------------------------------
--HIS_MILEAGE
